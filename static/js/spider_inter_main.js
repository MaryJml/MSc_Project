...
const focusUnknownLength = 25;

const focusYearScale = d3.scaleLinear()
    .domain([minYearDiff, maxYearDiff])
    .range([25, 60]);
const focusedWebWidth = 350;
